...
public:
    ...
    void DetectMarketRegime() {
        ...
        ArrayCopy(m_priceBuffer, m_priceBuffer, 1, 0, RegimeWindow - 1);
        ArrayCopy(m_volumeBuffer, m_volumeBuffer, 1, 0, RegimeWindow - 1);
        ArrayCopy(m_volatilityBuffer, m_volatilityBuffer, 1, 0, RegimeWindow - 1);
