...
**Vulnerability:** Reading arbitrarily large files into memory without size validation can lead to resource exhaustion and Denial of Service (DoS).
**Learning:** The need to treat file contents as untrusted input.
