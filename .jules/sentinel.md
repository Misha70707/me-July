...
**Vulnerability:** Uncontrolled Resource Consumption due to reading arbitrary files into memory without size limits.
**Learning:** Treating file contents as untrusted input is necessary to prevent DoS via resource exhaustion.
