...
**Vulnerability:** Uncontrolled resource consumption (DoS) when reading file contents into memory without size limits.
**Learning:** File contents must be treated as untrusted input.
