...
**Vulnerability:** Uncontrolled Resource Consumption (DoS) when reading large files into memory.
**Learning:** Need to treat file contents as untrusted input. Arbitrarily large files can cause memory exhaustion.
