...
def analyze_python_code(root_path):
    ...
    Bolt Optimization: Replaced Path.rglob("*.py") with os.walk to allow early pruning
    of ignored directories (like .venv). This avoids deep traversal of ignored trees
