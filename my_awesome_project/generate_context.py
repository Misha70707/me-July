...
def main():
    ...
    print(f"   📄 Files Scanned: {sum(len(files) for files in structure.values())}")
    print(f"   🐍 Classes found: {len(code_elements['classes'])}")
    print(f"   🛠️  Functions found: {len(code_elements['functions'])}")
    print("   -----------------------------------")
    print("   - Readme.md")
    print("   - Agents.md")
...
if __name__ == "__main__":
    try:
        ...
        if "TemplateNotFound" in str(e):
             print("   Tip: Ensure templates are in the same directory as this script.")
